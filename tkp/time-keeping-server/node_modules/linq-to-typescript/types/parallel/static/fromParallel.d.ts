import { IParallelEnumerable, ParallelGeneratorType } from "../../types/index.js";
type FromParallelFunc = {
     ...
     */
    <TSource>(type: ParallelGeneratorType.ArrayOfPromises, generator: () => Promise<TSource>[]): IParallelEnumerable<TSource>;
    /**
     ...
     * @returns IParallelEnumerable<T>
     */
    <TSource>(type: ParallelGeneratorType.PromiseToArray, generator: () => Promise<TSource[]>): IParallelEnumerable<TSource>;
    /**
     ...
     * @returns IParallelEnumerable<T>
     */
    <TSource>(type: ParallelGeneratorType.PromiseOfPromises, generator: () => Promise<Promise<TSource>[]>): IParallelEnumerable<TSource>;
};
export declare const fromParallel: FromParallelFunc;
export {};
